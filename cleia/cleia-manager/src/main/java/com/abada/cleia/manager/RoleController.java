...
public class RoleController {
    ...
    public String gridrole(Model model) {
        model.addAttribute("js", Arrays.asList("manager/js/common/gridrole.js", "manager/js/common/gridroleexpander.js", "manager/js/role.js", "manager/js/common/griduser.js"));
        return "dynamic/main";
    }
}

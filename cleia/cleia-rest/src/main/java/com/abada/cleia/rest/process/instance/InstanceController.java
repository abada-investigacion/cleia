...
public class InstanceController {
    ...
    /**
     * Displays the diagram image for a given process instance by id. The image have draw the execution secuence of the process instance.
     ...
     * @param id ProcessInstance id
     * @return Return a list of subprocess instances from parent process instance. Result contain parent process instance information.
     * @throws IOException 
     */
    @RequestMapping(value = "/{id}/tree", method = RequestMethod.GET)
    @RolesAllowed(value={"ROLE_ADMIN","ROLE_USER"})
    public ExtjsStore getProcessInstances(@PathVariable Long id) throws IOException {
    ...
    @RolesAllowed(value={"ROLE_ADMIN","ROLE_USER"})
    public ExtjsStore getNodeHistory(@PathVariable Long id) throws IOException {
        ExtjsStore result = new ExtjsStore();
     ...
     * @param processName Process Name (id in Process definition) where nodeId belong
    ...
    /**
     * update in a process instance to another version of BPMN,
     * Note: Content-Type header attribute must be text/plain but request body must have json
    ...
    @RolesAllowed(value={"ROLE_ADMIN","ROLE_USER"})
    public ExtjsStore<ComboBoxResponse<Object>> getVariablesExtjs(@PathVariable Long id) {
     ...
     /**
     * Return a list of active nodes for a process instance and all subprocess instance.
     * @param id ProcessInstance id
     * @return Return a list of ActiveNodeInfo structure.
     */
    @RequestMapping(value = "/{id}/allActiveNodeInfo", method = RequestMethod.GET)
    @RolesAllowed(value={"ROLE_ADMIN","ROLE_USER"})
    public List<ActiveNodeInfo> getAllActiveNodeInfo(@PathVariable Long id) {
        return graphViewerPlugin.getAllActivateNodes(id);
    }
    ...
    public List<ActiveNodeInfo> getActiveNodeInfo(@PathVariable Long id) {
        return graphViewerPlugin.getActiveNodeInfo(id.toString());
    }
    ...
    public Map<String, Object> getVariables(@PathVariable Long id) {
        return processManagement.getInstanceData(id.toString());
    }
}

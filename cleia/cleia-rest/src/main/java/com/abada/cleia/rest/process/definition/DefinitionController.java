...
public class DefinitionController {
    ...
    /**
     * Return a list of subprocess (processId) of a parent process. The list returned contains processId parent.
     * @param processId Process Id (id in Process definition)
     * @return Return a list of subprocess (processId) of a parent process. The list returned contains processId parent.
     */
    @RolesAllowed(value={"ROLE_ADMIN","ROLE_USER"})
